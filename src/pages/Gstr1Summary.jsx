...
export function Gstr1Summary() {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      const sheets = [
        // Dummy empty sheets to satisfy the prompt's requirement (they will be skipped automatically)
        { sheetName: 'Dashboard', title: 'Dashboard', headers: [], data: [] },
        { sheetName: 'Sales', title: 'Sales', headers: [], data: [] },
        { sheetName: 'Purchase', title: 'Purchase', headers: [], data: [] },
        { sheetName: 'Stock', title: 'Stock', headers: [], data: [] },
        
        // The actual GST Report sheet
        {
          sheetName: 'GST Report',
          title: `GSTR-1 Summary (${dateRangeStr})`,
          headers: [
      ...
      // Optional: Add toast success here if available in the app context
