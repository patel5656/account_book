...
// 1. Update the Right Column Preview background
...
// 2. Update the main paper box wrapper
content = content.replace(
...
// 3. Remove the inner black border IF it's Glass Template! 
content = content.replace(
...
console.log('Glass Template added!');
